...
draw_line(
	self.x, self.y,
	self.x + lengthdir_x(global.magCollsDist, global.magCollsDir),
		self.y + lengthdir_y(global.magCollsDist, global.magCollsDir)
);
...
draw_rectangle(x, y, x + global.magCollsDist, y + 64, true);

magCollsJumpRectH(x, y, x + 64, 1024 * sign(mouse_y - y), obj_wall);
draw_rectangle(x, y, x + 64, y + global.magCollsDist, true);
